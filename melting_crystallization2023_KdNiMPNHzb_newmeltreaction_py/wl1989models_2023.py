...
# get the liquidus T, which can be set as T_start
...
# fractional xtalization controlled by temperature, get liquid fraction, phase fractions, liquid and phase compositions in wt.%
